...
<tileset version="1.9" tiledversion="1.9.2" name="sword_projectile" tilewidth="32" tileheight="32" tilecount="8" columns="8">
 <image source="../../../tests/sword_projectile.png" width="256" height="32"/>
 <tile id="0">
  <animation>
