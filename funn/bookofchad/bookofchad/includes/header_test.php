...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<link href="../images/faviconTran.ico" rel="shortcut icon" />
...
?>
<div id="header"><div id="logo"><a href="home.php"><img src="../images/bigLeaguezLogo.png"></a></div><p style='float: right; position: relative; text-align: right; font-size: 0.8em;'>chadmin@bigleaguez.com
<br /><a href='http://nwobama.com'><img src='../images/faviconNWO.png' /></a>&nbsp;&nbsp;<a href='http://smittycreek.com'><img src='../images/faviconSmitty.png' /></a>&nbsp;&nbsp;<a href='https://github.com/BigLeaguez/ChadGasm'><img src='../images/github.png' /></a></p>
	...
	<div id="search">
		...
		<form action="search.php" method="get">
			<input type="text" name="search" placeholder="search yo" />
...
<nav>
	<ul>
		...
		<li><a <?php if($page=='Games') {echo "class='gamesActive'";} ?>href="games.php"><div id="games">Games</div></a></li>
		...
		<li><a <?php if($page=='Store') {echo "class='storeActive'";} ?>href="store.php"><div id="store">Store</div></a></li>
